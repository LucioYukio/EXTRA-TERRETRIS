...
from config.sounds import TETRIS_RODAR, TETRIS_LIMPA_LINHA, TETRIS_COLAR
from tetris.grid import TetrisGrid
    ...
    def handle_filled_lines(self):
        ...
        for linha in self.matrix:
            ...
            if cheia:
                ...
                TETRIS_LIMPA_LINHA.stop()
                TETRIS_LIMPA_LINHA.play()
