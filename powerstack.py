from screen import Object, Vector2, List, EMPTY_PIXEL

class PowerStack(Object):
    def __init__(self, icon_size: Vector2, n_icons: int, gap: int, tabs: List[int], z: int = 0, image: str = "assets/images/powers_nave.png", total_frames: int = 10):
